...

{
  ...
  "description": "This is an unofficial Google Tag Manager custom template for the trbo personalization platform. It allows tracking of all important data points along the on-site customer journey.",
  "containerContexts": [
    "WEB"
  ]
}
